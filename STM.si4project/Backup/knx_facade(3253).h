...
template <class P, class B> class KnxFacade : private SaveRestore
{
  public:
    ...
    void start()
    {
        ...
        {
            // Workaround for https://github.com///**//Print///**//PrintCore-samd/issues/587
            #if (//**//Print_API_VERSION >= 10200)
...
//#ifndef KNX_NO_AUTOMATIC_GLOBAL_INSTANCE
        ...
        #else
            #error "Mask version not supported on //**//Print_ARCH_STM32"
        #endif
    #else // Non-//**//Print platforms and Linux platform
