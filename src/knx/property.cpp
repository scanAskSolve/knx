...
Property::Property(RouterObject *io, PropertyID id,
                   ...
                   void (*stateCallback)(RouterObject *, uint8_t *, uint8_t, uint8_t *, uint8_t &)) : _id(id), _writeEnable(false), _type(PDT_FUNCTION), _maxElements(1), _access(ReadLv0 | WriteLv0), _interfaceObject(io), _commandCallback(commandCallback), _stateCallback(stateCallback)
{
}

Property::Property(ApplicationProgramObject *io, PropertyID id, bool writeEnable, PropertyDataType type, uint16_t maxElements,
...
Property::Property(ApplicationProgramObject *io, PropertyID id, bool writeEnable, PropertyDataType type, uint16_t maxElements,
                   uint8_t access, uint8_t (*readCallbackApplication)(ApplicationProgramObject *, uint16_t, uint8_t, uint8_t *))
    : _id(id), _writeEnable(writeEnable), _type(type), _maxElements(maxElements), _access(access), _interfaceObjectApplication(io), _readCallbackApplication(readCallbackApplication)
{
    _callback = true;
}
Property::Property(DeviceObject *io, PropertyID id, bool writeEnable, PropertyDataType type, uint16_t maxElements,
...
Property::Property(DeviceObject *io, PropertyID id, bool writeEnable, PropertyDataType type, uint16_t maxElements,
                   uint8_t access, uint8_t (*readCallbackDevice)(DeviceObject *, uint16_t, uint8_t, uint8_t *))
    : _id(id), _writeEnable(writeEnable), _type(type), _maxElements(maxElements), _access(access), _interfaceObjectDevice(io), _readCallbackDevice(readCallbackDevice)
{
    _callback = true;
}
Property::Property(TableObject *io, PropertyID id, bool writeEnable, PropertyDataType type, uint16_t maxElements,
...
Property::Property(TableObject *io, PropertyID id, bool writeEnable, PropertyDataType type, uint16_t maxElements,
                   uint8_t access, uint8_t (*readCallbackTable)(TableObject *, uint16_t, uint8_t, uint8_t *))
    : _id(id), _writeEnable(writeEnable), _type(type), _maxElements(maxElements), _access(access), _interfaceObjectTable(io), _readCallbackTable(readCallbackTable)
{
    _callback = true;
}
...
// }
// uint8_t Property::write(uint16_t start, uint8_t count, const uint8_t *data) override
// {
//     if (_callback)
//     {
