...
void Memory::writeMemory()
{
    ...
    flashPos = _platform.writeNonVolatileMemoryWithBuffer(flashPos, buffer, bufferPos - buffer);
...
{
    _platform.writeNonVolatileMemoryWithBuffer(relativeAddress, data, size);
}
